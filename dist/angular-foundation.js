...
angular
	...
	.provider('$modal', function () {
		...
		this.$get = ["$rootScope", "$window", "$fd", "$animate", "$q", "$timeout", "$compile", "$document", "$templateCache", function ($rootScope, $window, $fd, $animate, $q, $timeout, $compile, $document, $templateCache) {
